...
class QANet(nn.Module):
    def __init__(self, n_head=4, embedding_dim=50, feature_concat='l_r', d_k=64, attention=True, gate=None):
        ...
        if self.attention:
            ...
            in_channel = embedding_dim
        self.position_embedding_L = nn.Embedding(24, embedding_dim)
        self.position_embedding_R = nn.Embedding(24, embedding_dim)
        self.linear_1 = nn.Linear(in_channel * 24 * 2, in_channel)
    ...
    def forward(self, L, R):
        ...
        # pos = torch.LongTensor(pos).expand(batchsize, 24)
